...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    statusCode: Schema.Attribute.Enumeration<
      ['Confirmed', 'Complete', 'Cancelled', 'Pending']
    >;
    totalFee: Schema.Attribute.Decimal & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiConfigurationConfiguration extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currencyCode: Schema.Attribute.String & Schema.Attribute.DefaultTo<'EUR'>;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    serviceFeeRate: Schema.Attribute.Decimal;
    taxRate: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0.14>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiDishDish extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    baseChefFee: Schema.Attribute.Decimal & Schema.Attribute.Required;
    chef: Schema.Attribute.Relation<'oneToOne', 'api::chef.chef'>;
    course: Schema.Attribute.Enumeration<['Starter', 'Main Course', 'Dessert']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cuisines: Schema.Attribute.Relation<'manyToMany', 'api::cuisine.cuisine'>;
    description: Schema.Attribute.String & Schema.Attribute.Required;
    dietaryType: Schema.Attribute.Enumeration<['Veg', 'Non-Veg', 'Vegan']>;
    feePerPerson: Schema.Attribute.Integer;
    imageUrl: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    ingredients: Schema.Attribute.Component<'chef-app.ingredient', true>;
    isFeatured: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::dish.dish'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    nutrition: Schema.Attribute.Component<'chef-app.nutrition', false>;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    favoriteChefs: Schema.Attribute.Relation<'oneToMany', 'api::chef.chef'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
